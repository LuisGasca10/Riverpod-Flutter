...
class _TodoView extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final currentFilter = ref.watch(tdooCurrentFilterProvider);
    final todosFilterd = ref.watch(filteredTodosProvider);
    return Column(
      children: [
        const ListTile(
        ...
        SegmentedButton(
          ...
          onSelectionChanged: (value) {
            ref
                .read(tdooCurrentFilterProvider.notifier)
        ...
        Expanded(
          child: ListView.builder(
            itemCount: todosFilterd.length,
            itemBuilder: (context, index) {
              final todo = todosFilterd[index];
